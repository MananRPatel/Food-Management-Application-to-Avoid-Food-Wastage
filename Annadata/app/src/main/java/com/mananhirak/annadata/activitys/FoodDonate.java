...
public class FoodDonate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed1=findViewById(R.id.act_f_d__foodnamename);
        ed2=findViewById(R.id.act_f_d__foodweightname);
        ed3=findViewById(R.id.act_f_d__foodpricename);
        ed4=findViewById(R.id.act_f_d__totalefoodname);
        ed5=findViewById(R.id.act_f_d__foodallinfoname);

        button=findViewById(R.id.act_f_d__submit);
        button1=findViewById(R.id.act_f_d__foodtimename);
        button2=findViewById(R.id.act_f_d__fooddatename);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(s1.isEmpty()){
                    ...
                    Time_Create();
                    Toast.makeText(FoodDonate.this,"Future Time"+Food_Time+"  "+Food_Date,Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    rdetail.setFood_price(0);
                    rdetail.setFood_point(Integer.parseInt(s3));
                    ...
                    Toast.makeText(FoodDonate.this,Food_Date+"  "+Food_Time,Toast.LENGTH_SHORT).show();
                    RMYDB db=new RMYDB(FoodDonate.this);
                    db.R_ADD_FOOD(rdetail);


                    Intent intent =new Intent(FoodDonate.this,MainActivity.class);
    ...
    public void Time_Create(){
        TimePickerDialog timePickerDialog=new TimePickerDialog(FoodDonate.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
