...
public class History_Donate_Adapter extends RecyclerView.Adapter<History_Donate_Adapter.ViewHolder> {

     List<BDETAIL> list;
     Context context;

    public History_Donate_Adapter(List<BDETAIL> list,Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.historycarddonate,parent,false);
        return new History_Donate_Adapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.t2.setText(("Point : "+rdetail.getFood_point()));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            t1=itemView.findViewById(R.id.card_donate_buyer);
            t2=itemView.findViewById(R.id.card_donate_point);
            t3=itemView.findViewById(R.id.card_donate_order);
            t4=itemView.findViewById(R.id.card_donate_food);
            t5=itemView.findViewById(R.id.card_donate_info);
            t6=itemView.findViewById(R.id.card_donate_time);
        }
    }
}
